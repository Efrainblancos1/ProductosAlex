dataJson = {
  productsData: [
    {
      idProduct: "1MedidorchorroúnicomodeloCDONE",
      nameProduct: "Medidor chorro único modelo CD ONE",
      detailGeneral: [
        { detailDescription: 'Clase metrológica MID *' },
        { detailDescription: 'R (Q3 / Q1) ≤250 H - ≤100 V' },
        { detailDescription: 'Módulo B', borderLine: true },
        { detailDescription: 'nº TCM 142/08-4627' },
        { detailDescription: 'Módulo D', borderLine: true },
        { detailDescription: 'nº 0119-SJ-A010-08' }
      ],
      detailList: [
        { characteristic: 'Ratio 250' },
        { characteristic: 'Dimensiones: ½” a 1”' },
        { characteristic: 'Totalizador: con visor de vidrio templado' },
        { characteristic: 'Registro: capsulado' },
        { characteristic: 'Cuerpo: Latón estampado' },
